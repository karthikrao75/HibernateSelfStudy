package com.karthik.FirstLevelCacheHibernateDemo.TesterPackage;
...
import com.karthik.FirstLevelCacheHibernateDemo.HibernateEntity.Userdetails;
...
public class Tester {
	...
	System.out.println(d.toString());
		...
		//since get is used in new session caching wont work here.
		//for this to work we will have to use second level caching.
		}
